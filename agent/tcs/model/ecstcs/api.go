...
type NetworkStatsSet struct {
	...
	RxBytesPerSecond *ULongStatsSet `locationName:"rxBytesPerSecond" type:"structure"`

	TxBytesPerSecond *ULongStatsSet `locationName:"txBytesPerSecond" type:"structure"`
}
